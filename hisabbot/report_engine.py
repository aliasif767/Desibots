...
def fetch_sales_summary(date_start, date_end=None, tenant_id="default"):
...
def fetch_top_products(date_start, date_end=None, limit=5, tenant_id="default"):
...
def fetch_stock_status(tenant_id="default"):
...
def fetch_low_stock(tenant_id="default"):
...
def fetch_payments(date_start, date_end=None, tenant_id="default"):
...
def fetch_payments_by_customer(date_start, date_end=None, limit=20, tenant_id="default"):
...
def fetch_pending_credit(limit=10, tenant_id="default"):
...
def fetch_top_customers(date_start, date_end=None, limit=5, tenant_id="default"):
...
def fetch_product_profit(date_start, date_end=None, tenant_id="default"):
...
def fetch_total_stock_value(tenant_id="default"):
...
def build_daily_report(tenant_id="default"):
    ...
    sales       = fetch_sales_summary(ts, te, tenant_id)
    prods       = fetch_top_products(ts, te, limit=5, tenant_id=tenant_id)
    stock       = fetch_stock_status(tenant_id)
    low         = fetch_low_stock(tenant_id)
    pays        = fetch_payments(ts, te, tenant_id)
    pays_detail = fetch_payments_by_customer(ts, te, limit=20, tenant_id=tenant_id)
    pending     = fetch_pending_credit(limit=8, tenant_id=tenant_id)
...
def build_weekly_report(tenant_id="default"):
    ...
    sales       = fetch_sales_summary(ts, te, tenant_id)
    prods       = fetch_top_products(ts, te, limit=5, tenant_id=tenant_id)
    customers   = fetch_top_customers(ts, te, limit=5, tenant_id=tenant_id)
    stock       = fetch_stock_status(tenant_id)
    low         = fetch_low_stock(tenant_id)
    pays        = fetch_payments(ts, te, tenant_id)
    pays_detail = fetch_payments_by_customer(ts, te, limit=20, tenant_id=tenant_id)
    pending     = fetch_pending_credit(limit=8, tenant_id=tenant_id)
    pprofit     = fetch_product_profit(ts, te, tenant_id)
...
def build_monthly_report(tenant_id="default"):
    now  = datetime.now()
    ts   = _month_start()
    te   = _month_end()
    ...
    pays        = fetch_payments(ts, te, tenant_id)
    pays_detail = fetch_payments_by_customer(ts, te, limit=20, tenant_id=tenant_id)
    pending     = fetch_pending_credit(limit=10, tenant_id=tenant_id)
    pprofit     = fetch_product_profit(ts, te, tenant_id)
    stk_val     = fetch_total_stock_value(tenant_id)
